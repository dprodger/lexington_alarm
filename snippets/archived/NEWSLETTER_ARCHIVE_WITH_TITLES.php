<?php
/**
 * SIMPLE NEWSLETTER ARCHIVE WITH TITLES
 * Type the title and paste the URL for each newsletter
 * 
 * SETUP:
...
function simple_newsletter_archive_with_titles() {
...
add_shortcode('newsletter_archive', 'simple_newsletter_archive_with_titles');
?>
