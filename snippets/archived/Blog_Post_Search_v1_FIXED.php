/**
 * Blog Post Search - Ajax Live Search (FIXED)
 * Searches all blog posts regardless of display status
 * 
 * FIX: Added Enter key handler to prevent redirect to shop page
...
function la_blog_search_box() {
    ...
    jQuery(document).ready(function($) {
        ...
        // PREVENT ENTER KEY FROM TRIGGERING SITE SEARCH (THE FIX)
        ...
        $searchInput.on('keyup', function(e) {
            // Ignore Enter key on keyup (already handled above)
