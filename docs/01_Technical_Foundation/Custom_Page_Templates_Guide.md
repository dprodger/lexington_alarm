# IMPORTANT: Custom Page Templates Guide for Lexington Alarm

## ⚠️ CRITICAL REFERENCE - ALWAYS CONSULT BEFORE CREATING CUSTOM PAGES
...
### Note: 
This will include the Kadence footer. If you use this pattern and want to hide the footer in print, you'll need aggressive CSS:
...
1. Check if using `wp_footer()` - remove it
...
3. Check browser print settings (headers/footers are browser setting, not CSS)
...
|------|--------------|------------|
| Massport Campaign | With Header, No Footer | #1397 |
| National Development Letter | With Header, No Footer | #1879 |
| Rhode Island Campaign | Standalone | (disabled) |

---

## Quick Reference

### Want full header + no footer?
```php
get_header();
// ... your content ...
</body>
...
**⚠️ REMEMBER: The key to no footer is NOT calling `wp_footer()` - Kadence hooks into it!**
